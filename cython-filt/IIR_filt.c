...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "IIR_filt",
    __pyx_k_import_numpy_as_np_cimport_nump, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("IIR_filt", __pyx_methods, __pyx_k_import_numpy_as_np_cimport_nump, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
